...
window.EXHIBIT_DATA = [
  {
    ...
    items: [
      ...
      { title: "Стой! Прочти рассказ о том, как боролась Русь с врагом!", author: "Т. А. Маврина" },
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Обеспечим высокий урожай в 1944 году! Дадим Фронту и стране больше продовольствия!",
        author: "В. Б. Корецкий",
      },
